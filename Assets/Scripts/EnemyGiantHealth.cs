...
public class EnemyGiantHealth : MonoBehaviour {
    ...
    void Update ()
    {
        ...
        if (enemyHP <= 0)
        {
            ...
            gameManagerScript.score += gameManagerScript.giantEnemyScore;
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            damageAmount = 40f;
            if (characterMvmtScript.speed != 3 && !characterMvmtScript.chargedArrow)
                damageAmount = 200f;
            damaged = true;
        }
    }
    ...
    void Restore()
    {
        Enemy.GetComponent<SpriteRenderer>().color = new Color(255, 255, 0, 255);
    }
}
