...
public class CharacterMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (Input.GetButtonDown("ChooseBow"))
            {
                SpearUse = false;
                BowUse = true;
                speed = 4;
            ...
            if (Input.GetButtonDown("ChooseSpear"))
            {
                BowUse = false;
                SpearUse = true;
                speed = 3;
        ...
        if (Input.GetButton("Fire1") && EnableRelease)
        {
    ...
    void UseBow(float move_horizontal, float move_vertical)
    {
        ...
        if (Input.GetButton("Fire1") || Input.GetButton("Fire2") || Input.GetButtonDown("Fire1") || Input.GetButtonDown("Fire2"))
            shooting = true;
        else
            shooting = false;
